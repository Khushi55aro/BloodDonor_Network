...
# Database
# Uses SQLite by default for easy setup; switch to MySQL via .env
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Blood Donor Network <noreply@blooddonornetwork.com>')
